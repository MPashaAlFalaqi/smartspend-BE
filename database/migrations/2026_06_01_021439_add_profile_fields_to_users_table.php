...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            // Menambahkan kolom-kolom profil yang kurang jika belum ada
            ...
            if (!Schema::hasColumn('users', 'avatar')) {
                $table->longText('avatar')->nullable()->after('jenis_kelamin'); // Menggunakan longText karena menyimpan string Base64 foto
            }
        });
    }
